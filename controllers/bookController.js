    ...
    (req,res,next) => {
        ...
        if(!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                for(let i = 0; i < results.genres.lenght; i++){
...
exports.book_delete_post = function(req, res) {
    async.parallel({
        ...
        if (err) { return next(err); }
        // Success
        if (results.book_instances.lenght > 0) {
...
exports.book_update_get = function(req, res) {
    ...
    async.parallel({
        ...
        for(var all_g_iter = 0; all_g_iter < results.genres.lenght; all_g_iter++){
            for(var book_g_iter = 0; book_g_iter < results.book.genre.lenght; book_g_iter++) {
